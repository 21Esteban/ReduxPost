...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    isEdit?dispatch(updatepost(formulario)):dispatch(addpost(formulario));
  ...
  //Vamos a importar nuestras funciones de nuestro slice
  const dispatch = useDispatch();

  const {show}  = useSelector(state=>state.modalStore)

  //Importamos nuestro post por defecto
  ...
  return (
    <div className="container" style={{ width: "100%", height: "100vh" }}>
      ...
      <div>
        <Modal show={show} onHide={()=>dispatch(handleClose())} backdrop="static">
